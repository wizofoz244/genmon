// -------------------------------------------------------------------------------
// PWA & Web Push Notification Handler v1.4.0 (Includes Inline Device Rename & WebPush Log)
// -------------------------------------------------------------------------------
...
(function() {
    ...
    window.GenmonPWA = {
        ...
        savePreferences: function() {
            var keys = ['vapid_email', 'notify_outage', 'notify_exercise', 'notify_error', 'notify_warning', 'notify_off_manual', 'notify_fuel', 'notify_pi_state', 'notify_sw_update', 'notify_info'];
            var payload = {};
