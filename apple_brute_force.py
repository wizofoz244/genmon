...
def main():
    ...
    sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), 'addon')))
    import genwebpush
    
    sub_path = genwebpush.GetSubscriptionsFile()
    if not os.path.exists(sub_path):
        print(f"ERROR: Could not find webpush_subscriptions.json at {sub_path}")
        return
