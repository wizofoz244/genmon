...
def test_apple_push():
    ...
    p256dh = apple_sub.get("keys", {}).get("p256dh")
    auth = apple_sub.get("keys", {}).get("auth")
    ...
    encrypted_data = http_ece.encrypt(
        ...
        dh=p256dh.encode('utf-8'),
        auth_secret=auth.encode('utf-8'),
        version="aes128gcm"
    )
