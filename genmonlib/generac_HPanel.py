...
class HPanelReg(object):
    ...
    THROTTLE_POSITION = [
        "0096",
        4,
    ]  # Throttle Position            * Different on G-Panel
    ...
    BATTERY_CHARGE_CURRNT = [
        "009a",
        4,
    ]  # Battery Charge Current       * Different on G-Panel
    ...
    OUTPUT_FREQUENCY = [
        "00b2",
        4,
    ]  # Output Frequency             * Different on G-Panel
    ...
    KEY_SWITCH_STATE = [
        "01a0",
        2,
    ]  # High Byte is True if Auto, Low Byte True if Manual (False if Off)
...
class HPanelIO(object):
    ...
    Alarms = {
        ...
        (
            "0082",
            0x0010,
        ): "Overcrank Alarm - Generator has unsuccessfully tried to start the designated number of times.",
        (
            "0082",
            0x0008,
        ...
        (
            "0082",
            0x0002,
        ): "Oil Temp Low Alarm - Oil Temperature has gone below minimum alarm limit.",
        # Output 2
        (
            "0083",
            0x8000,
        ): "Oil Temp High Warning - Oil Temperature has gone above maximum warning limit.",
        (
            "0083",
            0x4000,
        ): "Oil Temp Low Warning - Oil Temperature has gone below minimum warning limit.",
        (
            "0083",
            0x2000,
        ): "Oil Temp Fault - Oil Temperature sensor exceeds nominal limits for valid sensor reading.",
        (
            "0083",
            0x1000,
        ): "Coolant Temp High Alarm - Coolant Temperature has gone above maximum alarm limit.",
        (
            "0083",
            0x0800,
        ): "Coolant Temp Low Alarm - Coolant Temperature has gone below mimimuim alarm limit.",
        (
            "0083",
            0x0400,
        ): "Coolant Temp High Warning - Coolant Temperature has gone above maximum warning limit.",
        (
            "0083",
            0x0200,
        ): "Coolant Temp Low Warning - Coolant Temperature has gone below mimimuim warning limit.",
        (
            "0083",
            0x0100,
        ): "Coolant Temp Fault - Coolant Temperature sensor exceeds nominal limits for valid sensor reading.",
        (
            "0083",
            0x0080,
        ): "Oil Pressure High Alarm - Oil Pressure has gone above maximum alarm limit.",
        (
            "0083",
            0x0040,
        ): "Oil Pressure Low Alarm - Oil Pressure has gone below mimimum alarm limit.",
        (
            "0083",
            0x0020,
        ): "Oil Pressure High Warning - Oil Pressure has gone above maximum warning limit.",
        (
            "0083",
            0x0010,
        ): "Oil Pressure Low Warning - Oil Pressure has gone below minimum warning limit.",
        (
            "0083",
            0x0008,
        ): "Oil Pressure Fault - Oil Pressure sensor exceeds nominal limits for valid sensor reading.",
        (
            "0083",
            0x0004,
        ): "Coolant Level High Alarm - Coolant Level has gone above maximum alarm limit.",
        (
            "0083",
            0x0002,
        ): "Coolant Level Low Alarm - Coolant Level has gone below minimum alarm limit.",
        (
            "0083",
            0x0001,
        ): "Coolant Level High Warning - Coolant Level has gone above maximum warning limit.",
        # Output 3
        (
            "0084",
            0x8000,
        ): "Coolant Level Low Warning - Coolant Level has gone below mimimum warning limit.",
        (
            "0084",
            0x4000,
        ): "Coolant Level Fault - Coolant Level sensor exceeds nominal limits for valid sensor reading.",
        (
            "0084",
            0x2000,
        ): "Fuel Level High Alarm - Fuel Level has gone above maximum alarm limit.",
        (
            "0084",
            0x1000,
        ): "Fuel Level Low Alarm - Fuel Level has gone below mimimum alarm limit.",
        (
            "0084",
            0x0800,
        ): "Fuel Level High Warning - Fuel Level has gone above maximum warning limit.",
        (
            "0084",
            0x0400,
        ): "Fuel Level Low Warning - Fuel Level has gone below mimimum warning limit.",
        (
            "0084",
            0x0200,
        ): "Fuel Level Fault - Fuel Level sensor exceeds nominal limits for valid sensor reading.",
        (
            "0084",
            0x0100,
        ): "Analog Input 6 High Alarm - Analog Input 6 has gone above maximum alarm limit (Fuel Pressure or Inlet Air Temperature).",
        (
            "0084",
            0x0080,
        ): "Analog Input 6 Low Alarm - Analog Input 6 has gone below mimimum alarm limit (Fuel Pressure or Inlet Air Temperature).",
        (
            "0084",
            0x0040,
        ): "Analog Input 6 High Warning - Analog Input 6 has gone above maximum warning limit (Fuel Pressure or Inlet Air Temperature).",
        (
            "0084",
            0x0020,
        ): "Analog Input 6 Low Warning - Analog Input 6 has gone below mimimum warning limit (Fuel Pressure or Inlet Air Temperature).",
        (
            "0084",
            0x0010,
        ): "Analog Input 6 Fault - Analog Input 6 sensor exceeds nominal limits for valid sensor reading (Fuel Pressure or Inlet Air Temperature).",
        (
            "0084",
            0x0008,
        ): "Throttle Position High Alarm - Throttle Position has gone above maximum alarm limit.",
        (
            "0084",
            0x0004,
        ): "Throttle Position Low Alarm - Throttle Position has gone below minimum alarm limit.",
        (
            "0084",
            0x0002,
        ): "Throttle Position High Warning - Throttle Position has gone above maximum warning limit.",
        (
            "0084",
            0x0001,
        ): "Throttle Position Low Warning - Throttle Position has gone below minimum warning limit.",
        # Output 4
        (
            "0085",
            0x8000,
        ): "Throttle Position Fault - Throttle Position sensor exceeds nominal limits for valid sensor reading.",
        (
            "0085",
            0x4000,
        ): "Analog Input 8 High Alarm - Analog Input 8 has gone above maximum alarm limit (Emissions Sensor or Fluid Basin).",
        (
            "0085",
            0x2000,
        ): "Analog Input 8 Low Alarm - Analog Input 8 has gone below minimum alarm limit (Emissions Sensor or Fluid Basin).",
        (
            "0085",
            0x1000,
        ): "Analog Input 8 High Warning - Analog Input 8 has gone above maximum warning limit (Emissions Sensor or Fluid Basin).",
        (
            "0085",
            0x0800,
        ): "Analog Input 8 Low Warning - Analog Input 8 has gone below minimum warning limit Emissions Sensor or Fluid Basin).",
        (
            "0085",
            0x0400,
        ): "Analog Input 8 Fault - Analog Input 8 sensor exceeds nominal limits for valid sensor reading (Emissions Sensor or Fluid Basin).",
        (
            "0085",
            0x0200,
        ): "Battery Charge Current High Alarm - Battery Charge Current has gone above maximum alarm limit.",
        (
            "0085",
            0x0100,
        ): "Battery Charge Current Low Alarm - Battery Charge Current has gone below minimum alarm limit.",
        (
            "0085",
            0x0080,
        ): "Battery Charge Current High Warning - Battery Charge Current has gone above maximum warning limit.",
        (
            "0085",
            0x0040,
        ): "Battery Charge Current Low Warning - Battery Charge Current has gone below minimum warning limit.",
        (
            "0085",
            0x0020,
        ): "Battery Charge Current Fault - Battery Charge Current sensor exceeds nominal limits for valid sensor reading.",
        (
            "0085",
            0x0010,
        ): "Battery Charge Voltage High Alarm - Battery Charge Voltage has gone above maximum alarm limit.",
        (
            "0085",
            0x0008,
        ): "Battery Charge Voltage Low Alarm - Battery Charge Voltage has gone below minimum alarm limit.",
        (
            "0085",
            0x0004,
        ): "Battery Charge Voltage High Warning - Battery Charge Voltage has gone above maximum warning limit.",
        (
            "0085",
            0x0002,
        ): "Battery Charge Voltage Low Warning - Battery Charge Voltage has gone below minimum warning limit.",
        (
            "0085",
            0x0001,
        ): "Battery Charge Voltage Fault - Battery Charge Voltage sensor exceeds nominal limits for valid sensor reading.",
        # Output 5
        (
            "0086",
            0x8000,
        ): "Average Current Low Alarm - Average Current has gone below minimum alarm limit.",
        (
            "0086",
            0x4000,
        ): "Average Current High Warning - Average Current has gone above maximum warning limit.",
        (
            "0086",
            0x2000,
        ): "Average Current Low Warning - Average Current has gone below minimum warning limit.",
        (
            "0086",
            0x1000,
        ): "Average Voltage High Alarm - Average Voltage has gone above maximum alarm limit.",
        (
            "0086",
            0x0800,
        ): "Average Voltage Low Alarm - Average Voltage has gone below minimum alarm limit.",
        (
            "0086",
            0x0400,
        ): "Average Voltage High Warning - Average Voltage has gone above maximum warning limit.",
        (
            "0086",
            0x0200,
        ): "Average Voltage Low Warning - Average Voltage has gone below minimum warning limit.",
        (
            "0086",
            0x0100,
        ): "Total Real Power High Alarm - Total Real Power has gone above maximum alarm limit.",
        (
            "0086",
            0x0080,
        ): "Total Real Power Low Alarm - Total Real Power has gone below minimum alarm limit.",
        (
            "0086",
            0x0040,
        ): "Total Real Power High Warning - Total Real Power has gone above maximum warning limit.",
        (
            "0086",
            0x0020,
        ): "Total Real Power Low Warning - Total Real Power has gone below minimum warning limit.",
        (
            "0086",
            0x0010,
        ): "Generator Frequency High Alarm - Generator Frequency has gone above maximum alarm limit.",
        (
            "0086",
            0x0008,
        ): "Generator Frequency Low Alarm - Generator Frequency has gone below minimum alarm limit.",
        (
            "0086",
            0x0004,
        ): "Generator Frequency High Warning - Generator Frequency has gone above maximum warning limit.",
        (
            "0086",
            0x0002,
        ): "Generator Frequency Low Warning - Generator Frequency has gone below minimum warning limit.",
        (
            "0086",
            0x0001,
        ): "Generator Frequency Fault - Generator Frequency sensor exceeds nominal limits for valid sensor reading.",
        # Output 6
        (
            "0087",
            0x8000,
        ): "Engine RPM High Alarm - Engine RPM has gone above maximum alarm limit.",
        (
            "0087",
            0x4000,
        ): "Engine RPM Low Alarm - Engine RPM has gone below minimum alarm limit.",
        (
            "0087",
            0x2000,
        ): "Engine RPM High Warning - Engine RPM has gone above maximum warning limit.",
        (
            "0087",
            0x1000,
        ): "Engine RPM Low Warning - Engine RPM has gone below minimum warning limit.",
        (
            "0087",
            0x0800,
        ): "Engine RPM Fault - Engine RPM exceeds nominal limits for valid sensor reading.",
...
class Output6(object):
    ...
    DI3_LINE_PWR_ACT = (
        0x0010  # DI-3, Digital Input #7 active Line Power digital input active
    )
    DI4_GEN_PWR_ACT = (
        0x0008  # DI-4, Digital Input #8 active Generator Power digital input active
    )
    LINE_POWER = 0x0004  #
    GEN_POWER = 0x0002  #
...
class HPanel(GeneratorController):
    ...
    def __init__(
        ...
        self.DaysOfWeek = {
            1: "Sunday",  # decode for register values with day of week
            2: "Monday",
            3: "Tuesday",
            4: "Wednesday",
            5: "Thursday",
    ...
    def GetConfig(self):
        ...
        try:
            ...
            self.FatalError(
                "Missing config file or config file entries (HPanel): " + str(e1)
            )
            return False
        ...
        try:
            with self.ExternalDataLock:
                ...
                Tile = MyTile(
                    ...
                    callbackparameters=(
                        self.Reg.BATTERY_VOLTS[REGISTER],
                        None,
                        100.0,
                        False,
                        False,
                ...
                if self.HTSTransferSwitch:
                    ...
                    Tile = MyTile(
                        ...
                        callback=self.GetParameter,
                        callbackparameters=(
                            self.Reg.EXT_SW_UTILITY_KW[REGISTER],
                            None,
                            None,
                            False,
                            True,
        ...
        try:
            ...
            if self.GetTransferStatus().lower() == "generator":
                if not self.SystemInOutage:
                    ...
                    msgbody = "\nUtility Power Out at " + self.OutageStartTime.strftime(
                        "%Y-%m-%d %H:%M:%S"
                    )
                    self.MessagePipe.SendMessage(
                        "Outage Notice at " + self.SiteName, msgbody, msgtype="outage"
                    )
    ...
    def RegisterIsFileRecord(self, Register):
        ...
        try:
            ...
            if Register == REGULATOR_FILE_RECORD:
                return True
            if (
                RegInt >= ALARM_LOG_START
                or RegInt <= ALARM_LOG_START + ALARM_LOG_ENTRIES
            ):
                return True
            if (
                RegInt >= EVENT_LOG_START
                or RegInt <= EVENT_LOG_START + EVENT_LOG_ENTRIES
            ):
                return True
    ...
    def SystemInAlarm(self):
        ...
        try:
            if (
                self.GetParameter(self.Reg.ACTIVE_ALARM_COUNT[REGISTER], ReturnInt=True)
                != 0
            ):
                return True
    ...
    def GetEngineState(self):
        ...
        try:
            ...
            State = self.GetParameterStringValue(
                RegisterStringEnum.ENGINE_STATUS[REGISTER],
                RegisterStringEnum.ENGINE_STATUS[RET_STRING],
            )
    ...
    def GetStatusForGUI(self):
        ...
        try:
            ...
            Status["OutputVoltage"] = self.GetParameter(
                self.Reg.AVG_VOLTAGE[REGISTER], "V"
            )
            Status["BatteryVoltage"] = self.GetParameter(
                self.Reg.BATTERY_VOLTS[REGISTER], "V", 100.0
            )
    ...
    def DisplayMaintenance(self, DictOut=False, JSONNum=False):
        ...
        try:
            ...
            NamePlateData = self.GetParameterFileValue(
                NAMEPLATE_DATA_FILE_RECORD, ReturnString=True
            )
            ...
            Maintenance["Maintenance"].append(
                {
                    "Controller Software Version": self.GetParameterStringValue(
                        RegisterStringEnum.VERSION_DATE[REGISTER],
                        RegisterStringEnum.VERSION_DATE[RET_STRING],
                    )
                }
            )
            ...
            Maintenance["Maintenance"].append(
                {
                    "Minimum GenLink Version": self.GetParameterStringValue(
                        RegisterStringEnum.MIN_GENLINK_VERSION[REGISTER],
                        RegisterStringEnum.MIN_GENLINK_VERSION[RET_STRING],
                    )
                }
            )
            ...
            Maintenance["Maintenance"].append(
                {
                    "Controller Power Up Time": self.GetTimeFromString(
                        self.GetParameterStringValue(
                            RegisterStringEnum.POWER_UP_TIME[REGISTER],
                            RegisterStringEnum.POWER_UP_TIME[RET_STRING],
                        )
                    )
                }
            )
            Maintenance["Maintenance"].append(
                {
                    "Controller Last Power Fail": self.GetTimeFromString(
                        self.GetParameterStringValue(
                            RegisterStringEnum.LAST_POWER_FAIL[REGISTER],
                            RegisterStringEnum.LAST_POWER_FAIL[RET_STRING],
                        )
                    )
                }
            )
            ...
            IOStatus.append(
                {
                    "Inputs": self.GetCondition(
                        RegList=[
                            self.Reg.INPUT_1[REGISTER],
                            self.Reg.INPUT_2[REGISTER],
                        ],
                        type="inputs",
                    )
                }
    ...
    def DisplayStatus(self, DictOut=False, JSONNum=False):
        ...
        try:
            ...
            Battery.append(
                {
                    "Battery Charger Current": self.ValueOut(
                        self.GetParameter(
                            self.Reg.BATTERY_CHARGE_CURRNT[REGISTER],
                            ReturnFloat=True,
                            Divider=10.0,
                        ),
                        "A",
            ...
            Engine.append(
                {
                    "Generator Status": self.GetParameterStringValue(
                        RegisterStringEnum.GENERATOR_STATUS[REGISTER],
                        RegisterStringEnum.GENERATOR_STATUS[RET_STRING],
                    )
                }
            ...
            Engine.append(
                {
                    "Power Factor": self.ValueOut(
                        self.GetParameter(
                            self.Reg.TOTAL_PF[REGISTER], ReturnFloat=True, Divider=100.0
                        ),
                        "",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Throttle Position": self.ValueOut(
                        self.GetParameter(
                            self.Reg.THROTTLE_POSITION[REGISTER], ReturnInt=True
                        ),
                        "Stp",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Coolant Level": self.ValueOut(
                        self.GetParameter(
                            self.Reg.COOLANT_LEVEL[REGISTER], ReturnInt=True
                        ),
                        "Stp",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Fuel Level": self.ValueOut(
                        self.GetParameter(
                            self.Reg.FUEL_LEVEL[REGISTER], ReturnInt=True
                        ),
                        "",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Current Phase A": self.ValueOut(
                        self.GetParameter(
                            self.Reg.CURRENT_PHASE_A[REGISTER], ReturnInt=True
                        ),
                        "A",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Current Phase B": self.ValueOut(
                        self.GetParameter(
                            self.Reg.CURRENT_PHASE_B[REGISTER], ReturnInt=True
                        ),
                        "A",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Current Phase C": self.ValueOut(
                        self.GetParameter(
                            self.Reg.CURRENT_PHASE_C[REGISTER], ReturnInt=True
                        ),
                        "A",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Average Current": self.ValueOut(
                        self.GetParameter(
                            self.Reg.AVG_CURRENT[REGISTER], ReturnInt=True
                        ),
                        "A",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Voltage A-B": self.ValueOut(
                        self.GetParameter(
                            self.Reg.VOLTS_PHASE_A_B[REGISTER], ReturnInt=True
                        ),
                        "V",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Voltage B-C": self.ValueOut(
                        self.GetParameter(
                            self.Reg.VOLTS_PHASE_B_C[REGISTER], ReturnInt=True
                        ),
                        "V",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Voltage C-A": self.ValueOut(
                        self.GetParameter(
                            self.Reg.VOLTS_PHASE_C_A[REGISTER], ReturnInt=True
                        ),
                        "V",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Average Voltage": self.ValueOut(
                        self.GetParameter(
                            self.Reg.AVG_VOLTAGE[REGISTER], ReturnInt=True
                        ),
                        "V",
                        JSONNum,
                    )
            ...
            Engine.append(
                {
                    "Air Fuel Duty Cycle": self.ValueOut(
                        self.GetParameter(
                            self.Reg.A_F_DUTY_CYCLE[REGISTER],
                            ReturnFloat=True,
                            Divider=10.0,
                        ),
                        "",
            ...
            Alarms.append(
                {
                    "Number of Active Alarms": self.ValueOut(
                        self.GetParameter(
                            self.Reg.ACTIVE_ALARM_COUNT[REGISTER], ReturnInt=True
                        ),
                        "",
                        JSONNum,
                    )
            ...
            Alarms.append(
                {
                    "Number of Acknowledged Alarms": self.ValueOut(
                        self.GetParameter(self.Reg.ALARM_ACK[REGISTER], ReturnInt=True),
                        "",
                        JSONNum,
                    )
                }
                    ...
                    Line.append(
                        {
                            "Target Utility Voltage": self.ValueOut(
                                self.GetParameter(
                                    self.Reg.EXT_SW_TARGET_VOLTAGE[REGISTER],
                                    ReturnInt=True,
                                ),
                                "V",
                                JSONNum,
                    ...
                    Line.append(
                        {
                            "Target Utility Frequency": self.ValueOut(
                                self.GetParameter(
                                    self.Reg.EXT_SW_TARGET_FREQ[REGISTER],
                                    ReturnInt=True,
                                ),
                                "Hz",
                                JSONNum,
                    ...
                    Line.append(
                        {
                            "Utility Current Phase A": self.ValueOut(
                                self.GetParameter(
                                    self.Reg.EXT_SW_UTILITY_AMPS_A[REGISTER],
                                    ReturnInt=True,
                                ),
                                "A",
                                JSONNum,
                    ...
                    Line.append(
                        {
                            "Utility Current Phase B": self.ValueOut(
                                self.GetParameter(
                                    self.Reg.EXT_SW_UTILITY_AMPS_B[REGISTER],
                                    ReturnInt=True,
                                ),
                                "A",
                                JSONNum,
                    ...
                    Line.append(
                        {
                            "Utility Current Phase C": self.ValueOut(
                                self.GetParameter(
                                    self.Reg.EXT_SW_UTILITY_AMPS_C[REGISTER],
                                    ReturnInt=True,
                                ),
                                "A",
                                JSONNum,
                    ...
                    Line.append(
                        {
                            "Switch Reported Generator Average Voltage": self.ValueOut(
                                self.GetParameter(
                                    self.Reg.EXT_SW_GEN_AVG_VOLT[REGISTER],
                                    ReturnInt=True,
                                ),
                                "V",
                                JSONNum,
    ...
    def GetRegulatorSettings(self):
        ...
        if len(RegData) >= (REGULATOR_FILE_RECORD_LENGTH * 2):
            try:
                ...
                RegSettings.append(
                    {"Target Volts": str(self.GetIntFromString(RegData, 6, 2)) + " V"}
                )  # Byte 6 and 7
                RegSettings.append(
                ...
                RegSettings.append(
                    {"Rated Power": str(self.GetIntFromString(RegData, 26, 2))}
                )  # Byte 26 and 27
                ...
                EngineSettings.append(
                    {
                        "Load Accept Frequency": str(
                            self.GetIntFromString(EngineData, 20, 2)
                        )
                        + " Hz"
                    }
                )  # Byte 20 and 21
                EngineSettings.append(
                    {
                        "Load Accept Voltage": str(
                            self.GetIntFromString(EngineData, 22, 2)
                        )
                        + " V"
                    }
                )  # Byte 22 and 23
    ...
    def GetGeneratorSettings(self):
        ...
        if len(GenData) >= (MISC_GEN_FILE_RECORD_LENGTH * 2):
            try:
                ...
                FlyWheelTeeth.append(
                    self.GetIntFromString(GenData, 4, 2)
                )  # Byte 4 and 5
                ...
                TargetRPM.append(
                    self.GetIntFromString(GenData, 13, 2)
                )  # Byte 13 and 14
                TargetRPM.append(
                    self.GetIntFromString(GenData, 15, 2)
                )  # Byte 15 and 16

                GeneratorSettings.append(
                    {"Target RPM": str(TargetRPM[0]) if len(TargetRPM) else "Unknown"}
                )
                GeneratorSettings.append(
                    {
                        "Number of Flywheel Teeth": str(FlyWheelTeeth[0])
                        if len(FlyWheelTeeth)
                        else "Unknown"
                    }
                )
                GeneratorSettings.append(
                    {"Phase": str(Phase) if Phase != None else "Unknown"}
                )
                self.Phase = str(Phase) if Phase != None else "Unknown"
                GeneratorSettings.append(
                    {"CT Ratio": str(CTRatio[0]) if len(CTRatio) else "Unknown"}
                )
        ...
        try:
            ...
            if not self.IndustrialOutageCheck:
                ...
                Outage["Outage"].append(
                    {"Status": "Yes" if self.SystemInOutage else "No"}
                )
            Outage["Outage"].append(
    ...
    def GetController(self, Actual=True):
        ...
        return self.GetParameterStringValue(
            RegisterStringEnum.CONTROLLER_NAME[REGISTER],
    ...
    def GetPowerOutputAlt(self, ReturnFloat=False):
        ...
        Current = float(
            self.GetParameter(self.Reg.AVG_CURRENT[REGISTER], ReturnInt=True)
        )
        Voltage = float(
            self.GetParameter(self.Reg.AVG_VOLTAGE[REGISTER], ReturnInt=True)
        )
    ...
    def GetBaseStatus(self):
        try:
            ...
            GeneratorStatus = self.GetParameterStringValue(
                RegisterStringEnum.GENERATOR_STATUS[REGISTER],
                RegisterStringEnum.GENERATOR_STATUS[RET_STRING],
            ).lower()
            ...
            if (
                ...
                IsExercising = False
            if self.HPanelDetected:
                ServiceDue = self.GetParameterBit(
                    self.Reg.OUTPUT_7[REGISTER], Output7.NEED_SERVICE
                )
            else:
